...
pub(crate) const COMMIT_HTML_TEMPLATE: &str =
    include_str!("../../../assets/diff_server/commit.html");

/// HTML template for the compare-branches page.
pub(crate) const COMPARE_HTML_TEMPLATE: &str =
    include_str!("../../../assets/diff_server/compare.html");
